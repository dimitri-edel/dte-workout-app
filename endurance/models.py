...
class Endurance(models.Model):
    ...
    owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name="owner_endurance")
    # The relationship to the owner object of type WorkoutExercise  
    workout_exercise = models.ForeignKey(WorkoutExercise,\
     on_delete=models.CASCADE, related_name="workout_exercise_endurance", default=0)
