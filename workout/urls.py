...
urlpatterns = [
    ...
    path(
        "rename_workout/<int:workout_id>",
        RenameWorkout.as_view(),
        name="rename_workout",
    ),
    path(
        "delete_workout_exercise/<int:workout_exercise_id>/<int:workout_id>",
        DeleteWorkoutExercise.as_view(),
        name="delete_workout_exercise",
    ),
    path("workout_list/", WorkoutList.as_view(), name="workout_list"),
    path(
        "delete_workout/<int:workout_id>",
        DeleteWorkout.as_view(),
        name="delete_workout",
    ),
]
