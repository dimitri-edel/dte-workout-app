...
class Running(models.Model):
    ...
    owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name="owner_running")
    # The relationship to the owner object of type WorkoutExercise  
    workout_exercise = models.ForeignKey(WorkoutExercise,\
     on_delete=models.CASCADE, related_name="workout_exercise_running", default=0)
